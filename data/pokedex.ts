export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	// NOTE: Glitch Pokemon with the same name are grouped into formes despite being different mons.
	m: {
		num: -1,
		name: "\u2019M",
		types: ["Bird", "Normal"],
	...
	// NOTE: Evolution Data will not be included here if a beta mon evolves from a non-beta mon.
	flambear: {
		num: -6000,
		name: "Flambear",
		types: ["Fire"],
